...
/**
 * \file    modulecompliancepld/core/boxes/modulecompliancepldwidget1.php
 * \ingroup modulecompliancepld
 * \brief   Widget provided by Modulecompliancepld
 *
 ...
 */
class modulecompliancepldwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "modulecompliancepldbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "modulecompliancepld@modulecompliancepld";
	 ...
	 */
	public $depends = array('modulecompliancepld');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		// Translations
		$langs->loadLangs(array("boxes", "modulecompliancepld@modulecompliancepld"));
		...
		// $this->hidden = !$user->hasRight('modulecompliancepld', 'myobject', 'read');
	}
	...
	public function loadBox($max = 5)
	{
		...
		//dol_include_once("/modulecompliancepld/class/modulecompliancepld.class.php");

		// Populate the head at runtime
		$text = $langs->trans("ModulecompliancepldBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_modulecompliancepld@modulecompliancepld',
