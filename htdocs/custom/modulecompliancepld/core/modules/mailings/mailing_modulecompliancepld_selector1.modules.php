...
dol_include_once("/modulecompliancepld/class/myobject.class.php");


/**
 * mailing_mailinglist_modulecompliancepld
 */
class mailing_mailing_modulecompliancepld_selector1 extends MailingTargets
{
	// CHANGE THIS: Put here a name not already used
	public $name = 'mailing_modulecompliancepld_selector1';
	// CHANGE THIS: Put here a description of your selector module
	public $desc = 'Emailing target selector1';
	// CHANGE THIS: Set to 1 if selector is available for admin users only
	public $require_admin = 0;

	public $enabled = 'isModEnabled("modulecompliancepld")';
	...
	{
		return '<a href="'.dol_buildpath('/modulecompliancepld/myobject_card.php', 1).'?id='.$id.'">'.img_object('', "generic").'</a>';
	}
			...
			while ($i < $num) {
				...
				if ($old != $obj->email) {
					$target[$j] = array(
						...
						'source_id' => $obj->id,
						'source_type' => 'myobject@modulecompliancepld'
					);
					$old = $obj->email;
					$j++;
				}
